...
{
    public class PenaltyAddService: CronJobService
    {
        private readonly ILogger<PenaltyAddService> _logger;
        private readonly ApplicationDbContext _context;
        private readonly ISchedulerService _schedulerService;

        public PenaltyAddService(IScheduleConfig<PenaltyAddService> config, ILogger<PenaltyAddService> logger, IServiceScopeFactory factory)
